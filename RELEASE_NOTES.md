...
- No Godot/Blender, no service_role, no `sb_secret_`, no fake benchmarks (legacy Godot 4.4 prototype archived 2026-09-18 at `archive/godot_legacy_2026-09-18/`; see `ASTRA_GODOT_LEGACY_AUDIT.md`)
